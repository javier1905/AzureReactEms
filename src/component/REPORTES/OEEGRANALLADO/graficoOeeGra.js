...
const GraficoOeeGra = ( props ) => {
    ...
    useEffect ( (  ) => {
        Servicios.listaOeeGranalladoGrafico (  idMaquina === '' ? null : idMaquina ,
        idPieza === '' ? null : idPieza ,  idMolde === '' ? null : idMolde , fechaProduccionDesde , fechaProduccionHasta ,
        idAgrupar , abortController , (vecFech , vecD , vecR  , vecQ , vecOEE , vecColoress , vecObjetivoMinn , vecObjetivoMaxx) =>{
        ...
        Servicios.listaMaquinas ( abortController ,  vec => {
            ...
            setVecMaquinas ( vec.filter ( m => m.idTipoMaquina === 1  ) )
        } )
